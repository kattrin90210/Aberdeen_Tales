...
<header class="mb-4 pt-1 pb-3">
    <div class="container">
        ...
        <ul class="nav nav-pills">
            <li class="nav-item">
                <a class="nav-link<?php echo $request_url == 'index.php' ? ' active' : '' ?>" href="index.php">Stories</a>
            </li>
            
            <li class="nav-item">
                <a class="nav-link<?php echo $request_url == 'users.php' ? ' active' : '' ?>" href="users.php">Users</a>
            </li>

            <li class="nav-item">
                <a class="nav-link<?php echo $request_url == 'feedback.php' ? ' active' : '' ?>" href="feedback.php">Feedback</a>
            </li>
        </ul>
    </div>
</header>
